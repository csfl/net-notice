module.exports = {
    ...
    main: {
        notice: {
            ...
            summary: "目前，Vite系统共有三种代币：VITE，VCP（Vite Community Point），VTT（Vite Test Token）。<br/> Web钱包1.2.0及桌面版钱包1.2.0新增PoW、抵押获取配额及注册SBP和投票功能；iOS钱包新增PoW、抵押获取配额及投票功能。区块浏览器新增SBP列表页，支持查看投票情况。Vite Pay 接入Vite Testnet 1.0.0后支付速度达到秒级。Vite Store 新增数种虚拟商品。",
