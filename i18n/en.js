module.exports = {
    ...
    main: {
        notice: {
            title1: "Voting for official SBPs to garner rewards，over <span class='strong-text'>8000+</span> VITE are waiting for your grab everyday",
            ctx: ["Vite TestNet incentive plan started at 13:30 (UTC+8:00) Nov 23, 2018",
                ...
                "Official SBPs of Vite: <span class='strong-text'>Vite_SBP01、Vite_SBP02、Vite_SBP03、Vite_SBP04、Vite_SBP05</span>",
                ...
                "These 5 SBPs are expected to generate <span class='strong-text'>8000+ </span>VITE as voting rewards, the earlier you vote, the more rewards you garner!"],
        },
        downloadWallet: {
