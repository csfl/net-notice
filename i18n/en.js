module.exports = {
    ...
    main: {
        notice: {
            title1: "Vote for official SBPs to collect rewards! Over <span class='strong-text'>8000+</span> VITE will be distributed every day!",
            ctx: ["Vite TestNet incentive plan started at 13:30 (UTC+8:00) Nov 23, 2018",
                ...
                "These five SBPs are expected to generate <span class='strong-text'>8000+ </span>VITE as voting rewards. The earlier you vote, the more rewards you collect!"],
        },
        downloadWallet: {
